...
return [
    ...
    */
    ...
    'attributes'           => [
        ...
        'select_1_1' => "'количество звонков на kyivstar'",
        'select_1_2' => "'длина звонков на kyivstar'",
        'select_1_3' => "'частота использования'",

        'select_2_1' => "'количество звонков на lifecell'",
        'select_2_2' => "'длина звонков на lifecell'",
        'select_2_3' => "'частота использования'",

        'select_3_1' => "'количество звонков на vodafone'",
        'select_3_2' => "'длина звонков на vodafone'",
        'select_3_3' => "'частота использования'",

        'select_4_1' => "'количество звонков на номера фиксированой связи'",
        'select_4_2' => "'длина звонков на номера фиксированой связи'",
        'select_4_3' => "'частота использования'",

        'select_5_1' => "'количество мегабайт'",
        'select_5_2' => "'частота использования'",

        'select_6_1' => "'количество смс'",
        'select_6_2' => "'частота использования'",

        'select_7_1' => "'количество ммс'",
        'select_7_2' => "'частота использования'",
    ],
